...
echo "<br>";
echo "&nbsp;<a href='?' style='border:2px solid red;width:80px;padding:0px 8px 0px 8px;'>H O M E</a>&nbsp;<a href='?shell&do=kill' style='border:2px solid red;width:80px;padding:0px 8px 0px 8px;'>K I L L </a>&nbsp;<a href='?byee&do=logout' style='color:red;border:2px solid red;width:80px;padding:0px 8px 0px 8px;'>L O G O U T</a>";
echo "</td></table>";
echo "<div id='menu'>";
echo "<hr>";
echo "<center>";
